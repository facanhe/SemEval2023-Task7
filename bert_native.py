...
if __name__ == '__main__':
    ...
    train_texts, train_labels, train_texts1,train_texts2,train_texts3,train_texts4 = [], [], [],[],[],[]
    for i, review in enumerate(train["Statement"]):
        train_texts.append(review)
        train_labels.append(train['Label'][i])
        train_texts1.append(train['Intervention'][i])
        train_texts2.append(train['Eligibility'][i])
        train_texts3.append(train['Results'][i])
        train_texts4.append(train['Adverse Events'][i])



    train_texts, val_texts,train_texts1, val_texts1,train_texts2, val_texts2,train_texts3, val_texts3,train_texts4, val_texts4, train_labels, val_labels = train_test_split(train_texts,train_texts1,train_texts2,train_texts3,train_texts4, train_labels, test_size=.2)

    tokenizer = BertTokenizerFast.from_pretrained('bert-base-uncased')

    train_encodings = tokenizer(train_texts,train_texts1,train_texts2, truncation=True, padding=True)
    val_encodings = tokenizer(val_texts,val_texts1,val_texts2, truncation=True, padding=True)
    ...
    optim = optim.AdamW(model.parameters(), lr=5e-6 )
